...
class EnableCors
{
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($request->isMethod('OPTIONS')) {
            ...
            return response('', 200)
                ->header('Access-Control-Allow-Origin', 'https://minassa-r74ync1bs-elsmrsoufianes-projects.vercel.app')
        ...
        // Add CORS headers
        $response->headers->set('Access-Control-Allow-Origin', 'https://minassa-r74ync1bs-elsmrsoufianes-projects.vercel.app');
